...
export const translations: Record<Language, TranslationSchema> = {
  EN: {
    ...
    // Corridors View
    corridorTitle: "North Tamil Nadu Railway Operations Demo – Chennai Central to Tiruvallur Corridor",
    corridorSubtitle: "Prototype operational blocks (B1–B5) with real-time train tracking, live station boards & dynamic block planning.",
    telemetrySummary: "Chennai Central – Tiruvallur Corridor Telemetry",
    officialRecord: "PROTOTYPE OPERATIONAL DEMO",
    latency: "LATENCY",
    activePaths: "PROTOTYPE BLOCKS",
    blocks: "BLOCKS (B1-B5)",
    savedHours: "SAVED HOURS",
    speed: "SPEED",
    today: "Live Operations",
    filter: "Filter",
    liveSignalInterlocking: "Corridor Signal Interlocking & Block Console",
    trackCircuitTelemetry: "Optical Block Occupancy Telemetry",
    speedLimitEnforced: "60km/h Restricted Speed Enforced",
    
    // Schedules View
    schedulesTitle: "North Tamil Nadu Corridor Train Timetable & Active Dispatch Roster",
    schedulesSubtitle: "Chennai Central to Tiruvallur active train allocation, priority slot control & automated dispatch advisory management.",
    rosterGazette: "CORRIDOR ROSTER",
    liveSynced: "LIVE SYNCHRONIZED",
    rosterTitle: "Active Corridor Schedules Roster (Chennai Central – Tiruvallur)",
    gazetteRecord: "OPERATIONAL RECORD",
    ...
    clearBtn: "Clear Path",
    dispatchSlotsSynced: "DISPATCH SLOTS SYNCHRONIZED ACROSS NORTH TAMIL NADU PROTOTYPE",
    allCategories: "All Categories",
    highSpeed: "Rajdhani / Vande Bharat / Superfast",
    heavyFreight: "Express / Heavy Freight",
    advisoriesTitle: "Live Corridor Advisories & Active Conflicts",
    activeConflicts: "ACTIVE CONFLICTS",
    
    // Network View
    networkTitle: "North Tamil Nadu Corridor Schematic & Real-Time Train Telemetry",
    networkSubtitle: "Chennai Central to Tiruvallur prototype operational blocks (B1 to B5) with mapped live train status.",
    activeTrainsGrid: "ACTIVE TRAINS IN CORRIDOR",
    telemetryLatency: "TELEMETRY LATENCY",
    trackHealthIndex: "TRACK HEALTH INDEX",
    zoomIn: "Zoom In",
    zoomOut: "Zoom Out",
    resetView: "Reset View",
    junctionStatus: "Basin Bridge Junction Status",
  ...
  HI: {
    ...
    // Corridors View
    corridorTitle: "उत्तरी तमिलनाडु रेलवे संचालन डेमो – चेन्नई सेंट्रल से तिरुवल्लूर कॉरिडोर",
    corridorSubtitle: "प्रोटोटाइप परिचालन ब्लॉक (B1-B5), वास्तविक समय ट्रेन ट्रैकिंग एवं ब्लॉक योजना।",
    telemetrySummary: "चेन्नई सेंट्रल – तिरुवल्लूर कॉरिडोर टेलीमेट्री",
    officialRecord: "प्रोटोटाइप परिचालन डेमो",
    latency: "विलंबता",
    activePaths: "प्रोटोटाइप ब्लॉक",
    blocks: "ब्लॉक (B1-B5)",
    savedHours: "सहेजे गए घंटे",
    speed: "गति",
    today: "लाइव संचालन",
    filter: "फ़िल्टर",
    liveSignalInterlocking: "कॉरिडोर सिग्नल इंटरलॉकिंग कंसोल",
    trackCircuitTelemetry: "ट्रैक सर्किट ऑप्टिकल टेलीमेट्री",
    speedLimitEnforced: "60 किमी/घंटा प्रतिबंधित गति लागू",
    
    // Schedules View
    schedulesTitle: "उत्तरी तमिलनाडु ट्रेन समय-सारणी एवं सक्रिय प्रेषण रोस्टर",
    schedulesSubtitle: "चेन्नई सेंट्रल से तिरुवल्लूर सक्रिय ट्रेन आवंटन, प्राथमिकता स्लॉट नियंत्रण।",
    rosterGazette: "कॉरिडोर रोस्टर",
    liveSynced: "लाइव सिंक्रनाइज़्ड",
    rosterTitle: "सक्रिय कॉरिडोर शेड्यूल रोस्टर (चेन्नई सेंट्रल – तिरुवल्लूर)",
    gazetteRecord: "परिचालन रिकॉर्ड",
    ...
    dispatchSlotsSynced: "उत्तरी तमिलनाडु प्रोटोटाइप में सिंक्रनाइज़ किए गए प्रेषण स्लॉट",
    allCategories: "सभी श्रेणियां",
    highSpeed: "राजधानी / वंदे भारत / सुपरफास्ट",
    heavyFreight: "एक्सप्रेस / भारी मालगाड़ी",
    advisoriesTitle: "लाइव कॉरिडोर परामर्श एवं सक्रिय संघर्ष",
    activeConflicts: "सक्रिय संघर्ष",
    
    // Network View
    networkTitle: "उत्तरी तमिलनाडु कॉरिडोर योजनाबद्ध मानचित्र एवं लाइव ट्रेन टेलीमेट्री",
    networkSubtitle: "चेन्नई सेंट्रल से तिरुवल्लूर प्रोटोटाइप ब्लॉक (B1 से B5) वास्तविक समय स्थिति।",
    activeTrainsGrid: "कॉरिडोर में सक्रिय ट्रेनें",
    telemetryLatency: "टेलीमेट्री विलंबता",
    trackHealthIndex: "ट्रैक स्वास्थ्य सूचकांक",
    zoomIn: "ज़ूम इन",
    zoomOut: "ज़ूम आउट",
    resetView: "पुनः सेट करें",
    junctionStatus: "बेसिन ब्रिज जंक्शन स्थिति",
  ...
  TA: {
    ...
    // Corridors View
    corridorTitle: "வட தமிழக ரயில்வே செயல்பாட்டு டெமோ – சென்னை சென்ட்ரல் முதல் திருவள்ளூர் பாதை",
    corridorSubtitle: "முன்மாதிரி செயல்பாட்டு பிரிவுகள் (B1-B5), நேரடி ரயில் கண்காணிப்பு & பிளாக் திட்டமிடல்.",
    telemetrySummary: "சென்னை சென்ட்ரல் – திருவள்ளூர் பாதை தொலைத் தகவல்",
    officialRecord: "முன்மாதிரி செயல்பாட்டு டெமோ",
    latency: "கால தாமதம்",
    activePaths: "முன்மாதிரி பிளாக்குகள்",
    blocks: "பிளாக்குகள் (B1-B5)",
    savedHours: "சேமிக்கப்பட்ட மணிநேரங்கள்",
    speed: "வேகம்",
    today: "நேரடி இயக்கம்",
    filter: "வடிகட்டி",
    liveSignalInterlocking: "பாதை சிக்னல் இணைப்பு கன்சோல்",
    trackCircuitTelemetry: "பாதை சுற்று ஆப்டிகல் தொலைத் தகவல்",
    speedLimitEnforced: "60 கி.மீ வேகக் கட்டுப்பாடு அமலில் உள்ளது",
    
    // Schedules View
    schedulesTitle: "வட தமிழக ரயில் காலஅட்டவணை மற்றும் இயக்க விவரிப்பு",
    schedulesSubtitle: "சென்னை சென்ட்ரல் முதல் திருவள்ளூர் ரயில் ஒதுக்கீடு, முன்னுரிமை கட்டுப்பாடு.",
    rosterGazette: "பாதை அரசிதழ்",
    liveSynced: "நேரடி இணைப்பு",
    rosterTitle: "செயலில் உள்ள ரயில் அட்டவணை (சென்னை சென்ட்ரல் – திருவள்ளூர்)",
    gazetteRecord: "செயல்பாட்டு பதிவு",
    ...
    dispatchSlotsSynced: "வட தமிழக முன்மாதிரியில் அனைத்து ரயில் பாதைகளும் இணைக்கப்பட்டுள்ளன",
    allCategories: "அனைத்து பிரிவுகளும்",
    highSpeed: "ராஜ்தானி / வந்தே பாரத் / அதிவேக ரயில்",
    heavyFreight: "எக்ஸ்பிரஸ் / கனரக சரக்கு ரயில்",
    advisoriesTitle: "நேரடி பாதை ஆலோசனைகள் & முரண்பாடுகள்",
    activeConflicts: "செயலில் உள்ள சிக்கல்கள்",
    
    // Network View
    networkTitle: "வட தமிழக ரயில் பாதை வரைபடம் மற்றும் நேரடி ரயில் தொலைத்தொடர்பு",
    networkSubtitle: "சென்னை சென்ட்ரல் முதல் திருவள்ளூர் முன்மாதிரி பிரிவுகள் (B1 முதல் B5) நேரடி நிலை.",
    activeTrainsGrid: "பரிந்துரைக்கப்பட்ட நேரடி ரயில்கள்",
    telemetryLatency: "தொலைத்தகவல் தாமதம்",
    trackHealthIndex: "பாதை ஆரோக்கிய குறியீடு",
    zoomIn: "பெரிதாக்கு",
    zoomOut: "சிறிதாக்கு",
    resetView: "மீட்டமை",
    junctionStatus: "பேசின் பிரிட்ஜ் சந்திப்பு நிலை",
