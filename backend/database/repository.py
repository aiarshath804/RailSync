        ...
        "assets": [
            {
                "id": 1,
                "asset_id": "TRK-01",
                "name": "MAS–BBQ Up Slow Track Bed (KM 0.0 - 2.2)",
                "asset_type": "TRACK",
                "line_section": "MAS-TRL Block B1",
                "start_km": 0.0,
                "end_km": 2.2,
                "speed_limit_kmh": 60,
                "status": "OPERATIONAL"
            },
            {
                "id": 2,
                "asset_id": "TRK-02",
                "name": "BBQ–PER Fast Line Switch Rails (KM 2.2 - 5.6)",
                "asset_type": "TRACK",
                "line_section": "MAS-TRL Block B2",
                "start_km": 2.2,
                "end_km": 5.6,
                "speed_limit_kmh": 90,
                "status": "OPERATIONAL"
            },
            {
                "id": 3,
                "asset_id": "SIG-44",
                "name": "Basin Bridge Junction Interlocking Point 44B",
                "asset_type": "SIGNAL",
                "line_section": "MAS-TRL Block B1-B2",
                "start_km": 2.1,
                "end_km": 2.3,
                "speed_limit_kmh": 110,
                "status": "OPERATIONAL"
            },
            {
                "id": 4,
                "asset_id": "OHE-09",
                "name": "25kV AC Traction Catenary Substation Villivakkam",
                "asset_type": "OHE",
                "line_section": "MAS-TRL Block B3",
                "start_km": 9.2,
                "end_km": 15.0,
                "speed_limit_kmh": 110,
                "status": "OPERATIONAL"
            },
            {
                "id": 5,
                "asset_id": "TRK-09",
                "name": "Avadi – Tiruvallur Suburban Fast Quadruple (KM 21.2 - 41.8)",
                "asset_type": "TRACK",
                "line_section": "MAS-TRL Block B5",
                "start_km": 21.2,
                "end_km": 41.8,
                "speed_limit_kmh": 110,
                "status": "OPERATIONAL"
        ...
        "train_schedules": [
            {
                ...
                "corridor_id": "MAS-TRL-05 (Chennai Central - Tiruvallur)",
            ...
            },
            {
                ...
                "name": "Arakkonam Container Freight",
